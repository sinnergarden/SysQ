...
Usage:
    python scripts/research/compute_labels.py --config configs/labels/<id>.yaml
    python scripts/research/compute_labels.py --universe csi800 --horizons 5 20 --overwrite
"""

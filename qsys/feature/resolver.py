...
_REQUIRED_FIELDS: dict[str, list[str]] = {
    ...
    "up_volume_down_volume_ratio_60d": ["close", "amount"],
    "up_volume_down_volume_ratio_120d": ["close", "amount"],
    "volume_contraction_after_rise_60d": ["close", "amount"],
    "quiet_accumulation_60d": ["close", "amount"],
    "amount_stability_60d": ["amount"],
    "breakout_volume_quality_120d": ["close", "amount"],

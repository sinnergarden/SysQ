...
def build_all_specs() -> list[FeatureSpec]:
    ...
    growth_specs = [
        ...
        FeatureSpec(feature_id="ttm_revenue_yoy", name="ttm_revenue_yoy",
            group="growth_confirmation_v0", kind="derived",
            dependencies=("ts_code",), pit_type="point_in_time",
            compute_fn="build_growth_confirmation_features",
            cache_scope="panel", status="active",
            description="TTM revenue year-over-year growth"),
        FeatureSpec(feature_id="single_q_revenue_yoy", name="single_q_revenue_yoy",
            group="growth_confirmation_v0", kind="derived",
            dependencies=("ts_code",), pit_type="point_in_time",
            compute_fn="build_growth_confirmation_features",
            cache_scope="panel", status="active",
            description="Single-quarter revenue year-over-year growth"),
        FeatureSpec(feature_id="is_profitable_ttm", name="is_profitable_ttm",
            group="growth_confirmation_v0", kind="derived",
            dependencies=("ts_code",), pit_type="point_in_time",
            compute_fn="build_growth_confirmation_features",
            cache_scope="none", status="active",
            description="Binary: TTM net profit > 0"),
        FeatureSpec(feature_id="gross_margin_delta_yoy", name="gross_margin_delta_yoy",
            group="growth_confirmation_v0", kind="derived",
            dependencies=("ts_code",), pit_type="point_in_time",
            compute_fn="build_growth_confirmation_features",
            cache_scope="panel", status="active",
            description="Single-quarter gross margin delta vs same quarter last year"),
        # Breakout

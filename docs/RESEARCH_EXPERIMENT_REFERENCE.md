...
### Ablation 年份表（strict 20d — v3a feature bugfix 后重跑）

| Year | v2 baseline | +margin | +shareholder | +full |
|------|:--------:|:------:|:----------:|:----:|
| 2020 | 0.3203 | **0.3629** | 0.2706 | 0.3185 |
| 2021 | 0.2541 | 0.2406 | 0.2192 | **0.2590** |
| 2022 | 0.3276 | **0.3343** | 0.3190 | 0.3260 |
| 2023 | 0.5219 | 0.5459 | 0.5403 | **0.5581** |
| 2024 | 0.4591 | 0.4728 | **0.4898** | **0.4898** |
| 2025 | 0.4502 | **0.5011** | 0.4610 | 0.4922 |
| **Overall** | **0.3980** | **0.4158** | 0.3886 | **0.4127** |
| **ICIR** | 2.949 | 2.886 | 2.355 | 2.632 |

**结论：**
- Margin (+0.018 IC, 4/6 年改善) — 弱阳性，近期年份更有信号（2025 +0.051）
- Shareholder (−0.009 IC, 3/6 年负) — 季频数据 PIT 后信息衰减严重
- Full (+0.015 IC) — margin 主导，shareholder 稀释
- 按 PR Pass/Fail 标准：Weak Pass
